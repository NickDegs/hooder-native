...
final class L10n {
    ...
    static let dict: [String:[String:String]] = [
        ...
        "map_downloading":  ["tr":"Harita indiriliyor","en":"Downloading map","es":"Descargando mapa","fr":"Téléchargement de la carte","de":"Karte wird geladen","it":"Download mappa","pt":"Baixando mapa","ru":"Загрузка карты","ar":"جارٍ تنزيل الخريطة","zh":"正在下载地图","ja":"マップをダウンロード中","ko":"지도 다운로드 중","az":"Xəritə yüklənir","uk":"Завантаження карти","fa":"در حال دانلود نقشه","hi":"मानचित्र डाउनलोड हो रहा है"],
        "city_downloading": ["tr":"Şehir mülkleri iniyor","en":"Loading city properties","es":"Cargando propiedades","fr":"Chargement des propriétés","de":"Lade Immobilien","it":"Caricamento proprietà","pt":"Carregando imóveis","ru":"Загрузка объектов","ar":"جارٍ تحميل العقارات","zh":"正在加载房产","ja":"物件を読み込み中","ko":"부동산 불러오는 중","az":"Şəhər mülkləri yüklənir","uk":"Завантаження об'єктів","fa":"در حال بارگیری املاک","hi":"संपत्तियाँ लोड हो रही हैं"],
        ...
        "retry":         ["tr":"Tekrar dene","en":"Retry","es":"Reintentar","fr":"Réessayer","de":"Erneut versuchen","it":"Riprova","pt":"Tentar de novo","ru":"Повторить","ar":"إعادة المحاولة","zh":"重试","ja":"再試行","ko":"다시 시도","az":"Yenidən","uk":"Повторити","fa":"تلاش مجدد","hi":"पुनः प्रयास"],
        "auth_checking": ["tr":"Kimlik doğrulanıyor…","en":"Verifying identity…","es":"Verificando identidad…","fr":"Vérification…","de":"Identität wird geprüft…","it":"Verifica identità…","pt":"Verificando…","ru":"Проверка…","ar":"جارٍ التحقق…","zh":"正在验证…","ja":"確認中…","ko":"확인 중…","az":"Yoxlanılır…","uk":"Перевірка…","fa":"در حال تأیید…","hi":"पहचान जाँच…"],
        "auth_required": ["tr":"Bağlantı ve kimlik gerekli","en":"Connection & identity required","es":"Se requiere conexión","fr":"Connexion requise","de":"Verbindung erforderlich","it":"Connessione richiesta","pt":"Conexão necessária","ru":"Требуется подключение","ar":"يلزم الاتصال والهوية","zh":"需要连接与身份","ja":"接続と認証が必要","ko":"연결과 인증 필요","az":"Bağlantı lazımdır","uk":"Потрібне з'єднання","fa":"اتصال لازم است","hi":"कनेक्शन आवश्यक"],
        "auth_online_note":["tr":"Hooder çevrimiçi oynanır. Devam etmek için internet bağlantısı gerekir.","en":"Hooder is played online. An internet connection is required to continue.","es":"Hooder se juega en línea. Se requiere internet.","fr":"Hooder se joue en ligne. Internet requis.","de":"Hooder wird online gespielt. Internet erforderlich.","it":"Hooder si gioca online. Serve internet.","pt":"Hooder é jogado online. Internet necessária.","ru":"Hooder играется онлайн. Нужен интернет.","ar":"تُلعب Hooder عبر الإنترنت. يلزم اتصال بالإنترنت.","zh":"Hooder 为在线游戏，需要联网。","ja":"Hooderはオンライン専用です。接続が必要です。","ko":"Hooder는 온라인 전용입니다. 인터넷이 필요합니다.","az":"Hooder onlayn oynanır. İnternet lazımdır.","uk":"Hooder грається онлайн. Потрібен інтернет.","fa":"Hooder آنلاین است. اینترنت لازم است.","hi":"Hooder ऑनलाइन है। इंटरनेट आवश्यक है।"],
